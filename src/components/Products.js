...
const Products = () => {
    ...
    console.log(productsData[0].heading)

    return (

        <div className='bg-[#dbdada] flex gap-[2rem] lg:px-[8vw] relative'>
            <div className='bg-white w-[25%] sticky shadow-[0px_0px_5px_0px_#808080] lg:flex hidden flex-col'>
                <div className="flex items-center gap-2 px-4 py-2">
                    <div className='text-xl'> <FaFire /></div>
                    <div>
                        <h3>Trending</h3>
            ...
            <div className='lg:w-[70%] w-full px-2'>
                {
                    productsData.map((products, idx) => (
                        <div key={idx}>
                            ...
                            <div className="products text-center  rounded-[15px] py-[1rem] overflow-hidden">
                                {
                                        ...
                                        <div key={idx2} className=''>
                                            <div className='bg-[white] lg:w-[200px] w-[150px] lg:h-[250px] h-[200px] rounded-xl mt-10 shadow-[0px_0px_5px_0px_#cdcdcd]'>
                                                ...
                                                <div className='p-2 mt-1 flex justify-between items-center flex-col h-[70%]'>
                                                    ...
                                                    <div className='flex justify-center items-center gap-2'><FaStar /> {product.rating}</div>
